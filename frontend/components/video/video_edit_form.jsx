...
const mapStateToProps = (state) => {
  return {
    video: state.ui.modal.currentVideo,
...
const mapDispatchToProps = (dispatch) => {
  return {
    updateVideo: (videoForm, videoId) => dispatch(updateVideo(videoForm, videoId)),
      ...
      <div className="video-form-container">
        ...
        <div className="video-form-info-container">
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <button type="submit" className="upload-btn" disabled={this.state.disableSubmit}>Save</button>
