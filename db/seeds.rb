...
vid4 = Video.create({title:"Why is this duck chasing me?", description: "Be sure to subscribe for more action packed adventure!", view_count: 272838, author_id: rain_user.id })
...
vid5 = Video.create({title:"Squeaking Frog", description: "Just a frog squeaking", view_count: 1272838, author_id: rain_user.id })
